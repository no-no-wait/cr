...
const monkeInfoArray = [SVGBlueInfo, SVGPinkInfo, SVGGreenInfo, SVGYellowInfo];
    ...
    <div className={s.root}>
        ...
        <div className={s.info}>
            ...
            <Slider {...settings} className={s.slider}>
                {monkeInfoArray.map((item) => {
                    return <div key={item}><img className={s.sliderImg} src={item} alt={item}/></div>
                })}
            </Slider>
        </div>
        <img src={SVGBussinessMonkey} className={s.bussinessMonkey} alt="bussiness monkey" />
    </div>
  )
}
